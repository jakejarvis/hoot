...
export function AppHeader() {
  ...
  return (
    <header className="sticky top-0 min-h-18 z-40 flex items-center gap-4 px-4 sm:px-6 py-3 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
      <Link
        href="/"
        className="inline-flex items-center justify-center h-14 w-14 rounded-md text-foreground hover:text-muted-foreground transition-all hover:scale-105 active:scale-95 duration-200"
